...
namespace TaskMaster
{
    public partial class Form1 : Form
    {
        ...
        {
            if (txtTask != null && cboStatus != null)
            {
            ...
            else MessageBox.Show("Task and Status are required.");
        }
        ...
        //t.Id, TaskName = t.Name, StatusName = t.Status.Name, t.DueDate
        ...
        private void btnUpdateTask_Click(object sender, EventArgs e)
        {
            ...
            else if(btnUpdateTask.Text == "Save")
            {
                var t = tmContext.Tasks.Find((int)dataGridView1.SelectedCells[0].Value);
                t.Name = txtTask.Text;
